...
Usage:
    ...
    log = configure_logging("cosmolex-mcp")
    log.info("startup", port=8080)
    log.error("api_call_failed", tool="list_clients", status=500, elapsed_ms=312)
...
def configure_logging(
    ...
    Args:
        service_name: short identifier shown on every log line (e.g. "cosmolex-mcp").
